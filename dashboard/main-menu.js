...
module.exports = function () {
    return [{
        ...
        submenu: Editor.isDarwin ? [{
            ...
            click() {
                Editor.Ipc.sendToMain("app:sign-out")
            },
            enabled: Editor.requireLogin
        }, {
            type: "separator"
        }, {
        ...
        submenu: [{
            ...
            click() {
                e.getFocusedWindow().reload()
            }
        }, {
            label: Editor.T("MAIN_MENU.developer.reload_no_cache"),
            accelerator: "CmdOrCtrl+Shift+R",
            click() {
                e.getFocusedWindow().reloadIgnoringCache()
            }
        }, {
            type: "separator"
        }, {
            ...
            click() {
                let r = e.getFocusedWindow(),
                    o = Editor.Window.find(r);
                o && o.send("editor:window-inspect")
            }
        }, {
